/* 
 * @author Antônio Barbosa 65659 e Tomás Martins 65668
 */
...
public class LogicIPuzzle {
    ...
    /**
     * metodo play da gameplay loop do jogo, recebe o scanner q vai ler o input do jogador, posicao
     * de preenchimento e seu conteudo digito ou preta e fazer print do puzzle com a mudança
     * @param sc scanner de leitura
     * @param rows linhas do puzzle
     * @param cols colunas do puzzle
     * @param puzzle conteudo do puzzle
     */
    ...
    public static boolean isRectangle(int rows, int cols, String spc, int digito, int posInicial) {
        ...
        // testar se atinge algum limite e nao pula pra fora do puzzle
        if (linhaInicial + altura - 1 > rows || colunaInicial + largura - 1 > cols) {
            return false;
        }
        // o retangulo e uma grid, que começa na linha inicial e se estende pra baixo pelas colunas
        //do retangulo possivel dos fatores do numero do digito se, em toda essa grid nao estiver o digito
        // respetivo sera falso, esse ciclo percorre a grid do retangulo
